...
import com.licoreria.pos.dto.AbonoCreditoDTO;
...
public class ClienteController {
    ...
    @GetMapping("/deudores")
    @PreAuthorize("@acceso.tiene('CLIENTES_GESTIONAR', 'VENTAS_CREAR', 'FACTURAS_VER')")
    public ResponseEntity<List<ClienteDTO>> deudores() {
        return ResponseEntity.ok(clienteService.deudores());
    }
    ...
    @PreAuthorize("@acceso.tiene('CLIENTES_GESTIONAR', 'VENTAS_CREAR')")
    public ResponseEntity<ClienteDTO> abonar(@PathVariable Long id, @Valid @RequestBody AbonoCreditoDTO dto) {
        return ResponseEntity.ok(clienteService.abonar(id, dto.getMonto()));
    }
}
